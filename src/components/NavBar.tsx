  ...
  return (
    <div className="flex items-center justify-between p-4 " >
      ...
      <div className='hidden md:flex items-center gap-2 text-xs rounded-full ring-[1.5px] ring-gray-300 px-2'>
        ...
        className="w-[200px] outline-none  bg-transparent p-2" />
      </div>
      {/* ICONS AND USER */}
      <div className="flex gap-6 items-center justify-end w-full">
        <div className="bg-white rounded-full w-7 h-7 flex items-center justify-center cursor-pointer">
          <Image src="/message.png" height={20} width={20} alt="msg" />
        </div>
        <div className="bg-white rounded-full w-7 h-7 flex items-center justify-center cursor-pointer relative">
          <Image src="/announcement.png" height={20} width={20} alt="msg" />
